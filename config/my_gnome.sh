...
description="Deploy my personal gnome configuration"
# version: 12.1
...
init_pkglists() {
    ...
    cp "${pkg_lists}"/gnome_base "${usefull}"
    cp "${pkg_lists}"/gnome_useless "${useless}"
}
...
user_config_menu() {
    ...
    softs_text="apply gnome config for '${user}' ?"
...
end_menu() {
    reboot_title="Custom gnome installed and configured"
